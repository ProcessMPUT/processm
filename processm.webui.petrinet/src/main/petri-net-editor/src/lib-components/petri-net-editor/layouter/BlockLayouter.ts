...
import { PlaceReductionFinder } from '@/lib-components/petri-net-editor/layouter/finders/PlaceReductionFinder';
...
} from '@/lib-components/petri-net-editor/layouter/finders/AbstractionReductionFinder';
...
} from '@/lib-components/petri-net-editor/layouter/finders/TransitionReductionFinder';
import { ShortLoopReductionFinder } from '@/lib-components/petri-net-editor/layouter/finders/ShortLoopReductionFinder';
...
export class BlockLayouter implements Layouter {
    ...
    public run(state: PetriNetState): PetriNetState {
        ...
        resultState.setLayoutMap(reducedState.getLayoutMap());
