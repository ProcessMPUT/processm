 ...
 * This file is derived from org.apache.flink.formats.json.JsonToRowDataConverters.java.
 * This file is distributed under ProcessM license and the original copyright statement is left for reference only.
 */
/*
...
public class JsonToRowDataConverters implements Serializable {
    ...
    private TimestampData convertToTimestamp(JsonNode jsonNode) {
        ...
        // patch: parse unix timestamp in microseconds
        var text = jsonNode.asText();
        try {
            var unixTimestamp = Long.parseLong(text);
            parsedTimestamp = LocalDateTime.ofEpochSecond(unixTimestamp / 1000000L, (int) ((unixTimestamp % 1000000L) * 1000L), ZoneOffset.UTC);
            ...
            switch (timestampFormat) {
                case SQL:
                    ...
                    break;
                case ISO_8601:
                    parsedTimestamp = ISO8601_TIMESTAMP_FORMAT.parse(text);
                    break;
                default:
