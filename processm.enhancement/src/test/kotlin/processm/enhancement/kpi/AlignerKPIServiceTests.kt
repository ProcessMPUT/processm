...
class AlignerKPIServiceTests {
    companion object {
        ...
        val wctObserver = TopicObserver(
            ...
            filter = "$WORKSPACE_COMPONENT_EVENT = '${WorkspaceComponentEventType.DataChange}' AND $WORKSPACE_COMPONENT_EVENT_DATA NOT IN ('${DataChangeType.Model}', '${DataChangeType.InitialModel}')"
        )
