...
class CausalNetTraceComparison(val left: Model, val right: Model) {
    ...
    val leftTraces by lazy {
        leftVerificationReport.validLoopFreeSequences.mapToSet { seq -> seq.map { it.a }.filterNot { it.special } }
    }
    ...
    val rightTraces by lazy {
        rightVerficiationReport.validLoopFreeSequences.mapToSet { seq -> seq.map { it.a }.filterNot { it.special } }
    }
