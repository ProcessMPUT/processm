...
class CausalNetTraceComparison(val left: CausalNet, val right: CausalNet) {
    ...
    val leftTraces by lazy {
        leftVerificationReport.validLoopFreeSequences.mapToSet { seq -> seq.map { it.a }.filterNot { it.isArtificial } }
    }
    ...
    val rightTraces by lazy {
        rightVerficiationReport.validLoopFreeSequences.mapToSet { seq ->
