    ...
    fun `Level A1 = XES Event data that only contains case identifiers and activity names`() {
        """<?xml version="1.0" encoding="UTF-8" ?>
            <log xes.version="1.0" xes.features="nested-attributes" openxes.version="1.0RC7" xmlns="http://www.xes-standard.org/">
                ...
                <string key="identity:id" value="bbf3f64f-2507-4f0b-a6f8-0113377d69e4"/>
                <trace>
                    <string key="concept:name" value="Trace #001"/>
                    <string key="identity:id" value="ae1a2f41-2d01-479d-b6a3-84f18d790b20"/>
                    <event>
                        <string key="concept:name" value="Event #1 in Trace #001"/>
                        <string key="identity:id" value="1419fcd5-8fed-4272-8037-453213d8b0d1"/>
                    </event>
                    <event>
                        <string key="concept:name" value="Event #2 in Trace #001"/>
                        <string key="identity:id" value="0e461b08-4f5e-4aa2-b0a2-b7779c82b119"/>
                    </event>
                </trace>
                <trace>
                    <string key="concept:name" value="Trace #002"/>
                    <string key="identity:id" value="a192d6c5-683b-4188-8f73-222227dd4796"/>
                    <event>
                        <string key="concept:name" value="Event #1 in Trace #002"/>
                        <string key="identity:id" value="1a912b4d-6c78-4a4e-8e0f-219fcea53ea7"/>
                    </event>
                    <event>
                        <string key="concept:name" value="Event #2 in Trace #002"/>
                        <string key="identity:id" value="8f14c2ec-83eb-4843-9cb4-c45456a5f3cb"/>
                    </event>
                </trace>
            </log>
